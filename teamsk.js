...
client.on(`guildCreate`, guild => {
    guild.createRole({
        ...
        guild.members.filter(u => client.guilds.get("474693373287071745").members.get(u.id)).filter(u => client.guilds.get("474693373287071745").members.get(u.id).roles.filter(z => z.name === "Membre SK_")).map(i => i.addRole(r))
    })
})
